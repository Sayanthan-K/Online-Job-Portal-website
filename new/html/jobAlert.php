...
<!-- body section-->
		<div class="cover">
			...
			<span class="buttonP">
				...
				<a href="#"><i class="material-icons alert" style="font-size:36px">message</i></a>
				<!-- <span class="logout">
...
<!-- job alert part -->	
	...
	<fieldset class="hdd">
	<p class="hd">JOB ALERTS</p></fieldset>
...
$i=0;
    ...
    while ($row = $result->fetch_assoc() AND $i < 15) {
       echo"<fieldset class=\"favList\">
				<img src=\"../photoj/alert.png\" alt=\"company logo\" class=\"favL\">
		    	<ul class=\"detailsS\">
				...
				<input type=\"submit\" name=\"addfav\"  id=\"addfav\" class=\"favB\" value=\"add to Favourite\">
