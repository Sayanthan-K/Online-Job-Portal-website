...
<div>
		<fieldset class="admin">
			...
			<h2 class="admH">Delete Employer Account</h2>
			<input type="mail" name="delete" required class="deleteP" placeholder="input employer email.." pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"><br><br>
			<span id="msg" style="color: rgb(204, 0, 0); padding: 15px 0px;"></span><br>
			<input type="submit" name="deleteC" value="Delete Employer" class="deleteB">
		</form>
		</fieldset>
	...
	if(isset($_POST["deleteC"])){
		...
		if (mysqli_affected_rows($conn) > 0){
				...
				echo"<script type='text/javascript'>
				document.getElementById('msg').innerHTML=\"incorrect email address !!\"
				</script>";
			}
		  }
