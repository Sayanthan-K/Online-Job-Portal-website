...
<?php
	...
	WHERE a.interview_id LIKE '$id' AND b.company_id LIKE a.employer_id AND c.job_id LIKE a.job_id";
	...
	if (mysqli_affected_rows($conn) > 0){
		 ...
		 while ($row = $result->fetch_assoc()){
		 	echo "<fieldset class=\"notif\">
					...
					<br>INTERVIEW DATE :  <span class=\"det\">".$row['interview_date']."</span>
					<br>INTERVIEW VENUE :  <span class=\"det\">".$row['interview_venue']."</span>
					<br>FOR FURTHER DETAILS :  <span class=\"det\">".$row['email']."</span>
					<br>NOTE BY COMPANY :  <span class=\"det\">".$row['notes']."</span>
				</fieldset>";
		 }
