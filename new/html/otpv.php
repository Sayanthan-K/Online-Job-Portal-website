...
<div>
	<fieldset class="select" id="loginH">
		...
		<p>haven't get OTP? <a class="linkP" href="../php/mailer.php">RESEND OTP</a></p>
	</form>
	</fieldset>
</div>
...
<?php
	...
	if ($otpcode == $otpcodeS) {
		...
		header("Location: ../html/setpassword.php");
		exit();
	}
	else{
		echo"<script type='text/javascript'>
				document.getElementById('msg').innerHTML=\"incorrect OTP !!<br>\"
				</script>";
	}
}
