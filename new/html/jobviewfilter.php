...
WHERE job_id LIKE '$search' AND a.company_id LIKE b.company_id";
...
if (mysqli_affected_rows($conn) > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
       echo"<div>
	<fieldset class=\"jobv\" id=\"jobv\">
		<table class=\"detailsJf\">
			<tr><td class=\"list\">JOB NAME </td><td  class=\"jobd\" id=\"jobname\">". $row["job_name"]."</td></li></tr> 
			<tr><td  class=\"list\">COMPANY NAME </td><td  class=\"jobd\" id=\"jobcompany\">". $row["company_name"]."</td></li> </tr> 
			<tr><td  class=\"list\">POSTED DATE </td><td  class=\"jobd\" id=\"jobdate\">". $row["posted_date"]."</td></li></tr> 
			<tr><td  class=\"list\">DUE DATE </td><td  class=\"jobd\" id=\"dues\">". $row["due_date"]."</td> </li></tr>  
			<tr><td  class=\"list\">SALARY </td><td  class=\"jobd\" id=\"jobsalary\">". $row["salary"]."</td></li></tr> 
			<tr><td  class=\"list\">LOCATION </td><td  class=\"jobd\" id=\"jobloc\">". $row["location"]."</td></li> </tr> 
			<tr><td  class=\"list\">QUALIFICATION </td><td  class=\"jobd\" id=\"jobq\">". $row["qualification"]."</td></li></tr> 
			</table><br>
			<form method=\"post\" action=\"../php/index.php\">
			<input type=\"hidden\" value=\"".$row['job_id']."\" name=\"jid\">
			".($validation == 2 ?  "<input type=\"submit\" class=\"applyB\" name=\"applyjob\" value=\"Apply Job\">":"")."
			".($validation == 2 ?  "<input type=\"submit\" class=\"applyB\" name=\"addfav1\" value=\"Add to Favorite\">":"")."
			</form>
	</fieldset>
</div>";
	...
	echo"<br><div class=\"classic\"><center>SORRY<br>*No results were found*</center></div>";
}
